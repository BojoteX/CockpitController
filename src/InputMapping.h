...
static const InputMapping InputMappings[] = {
    ...
    { "AUX_REL_SW_ENABLE"          , "PCA_0x22" ,  0 ,  1 ,  -1 , "AUX_REL_SW"             ,   1 , "selector" ,  1 },
    { "AUX_REL_SW_NORM"            , "PCA_0x22" ,  0 ,  1 ,  -1 , "AUX_REL_SW"             ,   0 , "selector" ,  1 },
    { "CMSD_DISPENSE_SW_BYPASS"    , "PCA_0x22" ,  0 ,  2 ,  -1 , "CMSD_DISPENSE_SW"       ,   2 , "selector" ,  2 },
    { "CMSD_DISPENSE_SW_ON"        , "PCA_0x22" ,  0 ,  2 ,  -1 , "CMSD_DISPENSE_SW"       ,   1 , "selector" ,  2 },
    { "CMSD_DISPENSE_SW_OFF"       , "PCA_0x22" ,  0 ,  3 ,  -1 , "CMSD_DISPENSE_SW"       ,   0 , "selector" ,  2 },
    ...
    { "IR_COOL_SW_ORIDE"           , "PCA_0x26" ,  0 ,  0 ,  -1 , "IR_COOL_SW"             ,   2 , "selector" ,  6 },
    { "IR_COOL_SW_NORM"            , "PCA_0x26" ,  0 ,  0 ,  -1 , "IR_COOL_SW"             ,   1 , "selector" ,  6 },
    { "IR_COOL_SW_OFF"             , "PCA_0x26" ,  0 ,  0 ,  -1 , "IR_COOL_SW"             ,   0 , "selector" ,  6 },
    ...
    { "SPIN_RECOVERY_SW_NORM"      , "PCA_0x26" ,  0 ,  0 ,  -1 , "SPIN_RECOVERY_SW"       ,   0 , "selector" ,  7 },
    { "MASTER_ARM_SW_ARM"          , "PCA_0x5B" ,  0 ,  0 ,  -1 , "MASTER_ARM_SW"          ,   1 , "selector" ,  8 },
    { "MASTER_ARM_SW_SAFE"         , "PCA_0x5B" ,  0 ,  0 ,  -1 , "MASTER_ARM_SW"          ,   0 , "selector" ,  8 },
    { "MASTER_MODE_AA"             , "PCA_0x5B" ,  0 ,  0 ,  -1 , "MASTER_MODE_AA"         ,   1 , "momentary",  0 },
    { "MASTER_MODE_AG"             , "PCA_0x5B" ,  0 ,  0 ,  -1 , "MASTER_MODE_AG"         ,   1 , "momentary",  0 },
