...
static const InputMapping InputMappings[] = {
    ...
    { "ECM_MODE_SW_XMIT"           , "PCA_0x22" , 0 , 4 , 2 , "ECM_MODE_SW"            ,   4 , "selector" ,  3 },
    { "ECM_MODE_SW_REC"            , "PCA_0x22" , 0 , 5 , 3 , "ECM_MODE_SW"            ,   3 , "selector" ,  3 },
    { "ECM_MODE_SW_BIT"            , "PCA_0x22" , 0 , 6 , 4 , "ECM_MODE_SW"            ,   2 , "selector" ,  3 },
    { "ECM_MODE_SW_STBY"           , "PCA_0x22" , 0 , 7 , 5 , "ECM_MODE_SW"            ,   1 , "selector" ,  3 },
    { "ECM_MODE_SW_OFF"            , "PCA_0x22" , 1 , 0 , 6 , "ECM_MODE_SW"            ,   0 , "selector" ,  3 },
