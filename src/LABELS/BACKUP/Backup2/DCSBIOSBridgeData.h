...
static const std::unordered_map<uint16_t,std::vector<const DcsOutputEntry*>> addressToEntries = {
    {0x740C,{&DcsOutputTable[0],&DcsOutputTable[1],&DcsOutputTable[50],&DcsOutputTable[51],&DcsOutputTable[52],&DcsOutputTable[53],&DcsOutputTable[54],&DcsOutputTable[55],&DcsOutputTable[56],&DcsOutputTable[68],&DcsOutputTable[69],&DcsOutputTable[70],&DcsOutputTable[71],&DcsOutputTable[72]}},
    {0x74A4,{&DcsOutputTable[2],&DcsOutputTable[3],&DcsOutputTable[5],&DcsOutputTable[6],&DcsOutputTable[7],&DcsOutputTable[8],&DcsOutputTable[11],&DcsOutputTable[12]}},
    {0x74A0,{&DcsOutputTable[4]}},
    {0x74A8,{&DcsOutputTable[9],&DcsOutputTable[10],&DcsOutputTable[13]}},
    {0x7514,{&DcsOutputTable[14]}},
    {0x7488,{&DcsOutputTable[15],&DcsOutputTable[19]}},
    {0x7484,{&DcsOutputTable[16],&DcsOutputTable[17]}},
    {0x74D4,{&DcsOutputTable[18]}},
    {0x740E,{&DcsOutputTable[20]}},
    {0x754A,{&DcsOutputTable[21]}},
    {0x74C8,{&DcsOutputTable[22],&DcsOutputTable[26]}},
    {0x7544,{&DcsOutputTable[23]}},
    {0x7548,{&DcsOutputTable[24]}},
    {0x7546,{&DcsOutputTable[25]}},
    {0x754C,{&DcsOutputTable[27]}},
    {0x740A,{&DcsOutputTable[28],&DcsOutputTable[29],&DcsOutputTable[30],&DcsOutputTable[33],&DcsOutputTable[34],&DcsOutputTable[38],&DcsOutputTable[59],&DcsOutputTable[60],&DcsOutputTable[61],&DcsOutputTable[62],&DcsOutputTable[63],&DcsOutputTable[64],&DcsOutputTable[65],&DcsOutputTable[66],&DcsOutputTable[67]}},
    {0x7408,{&DcsOutputTable[31],&DcsOutputTable[32],&DcsOutputTable[35],&DcsOutputTable[36],&DcsOutputTable[37],&DcsOutputTable[39],&DcsOutputTable[40],&DcsOutputTable[41],&DcsOutputTable[42],&DcsOutputTable[43],&DcsOutputTable[44],&DcsOutputTable[57],&DcsOutputTable[58]}},
    {0x7456,{&DcsOutputTable[45]}},
    {0x742A,{&DcsOutputTable[46],&DcsOutputTable[47],&DcsOutputTable[48],&DcsOutputTable[49]}},
};
